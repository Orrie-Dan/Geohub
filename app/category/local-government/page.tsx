...
import { Search, ArrowLeft, ExternalLink, Grid, List, X, MapPin, Users, Building, FileText, Calendar } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { ScrollReveal } from "@/components/scroll-reveal"
import { ScrollProgress } from "@/components/scroll-progress"

// Local government services data
const governmentServices = [
  {
    id: 1,
    title: "District Situation Room Application",
    ...
    link: "https://infrastructure.space.gov.rw/portal/home/index.html",
...
export default function LocalGovernmentPage() {
  ...
  const searchServices = useCallback((query: string) => {
    if (!query.trim()) return governmentServices
  ...
  // Memoized filtered services with title-only search
            ...
            <ScrollReveal>
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-slate-200 max-w-3xl mx-auto drop-shadow-sm">
                  Access comprehensive digital government services designed to serve citizens, 
                  businesses, and communities across Rwanda's districts and sectors
                </p>
              </div>
              ...
              <div className="max-w-4xl mx-auto mb-8">
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="relative flex-1">
                    <Input
                      type="text"
                      placeholder="Search government services by name..."
                      value={searchQuery}
              ...
              <div className="text-center text-slate-300 mb-8">
                <p>
                  {searchQuery ? (
                    <>
                      Found <span className="text-sky-400 font-semibold">{filteredServices.length}</span> services
                      <span className="text-slate-400"> matching "{searchQuery}"</span>
                    </>
                  ) : (
                    <>
                      Showing <span className="text-sky-400 font-semibold">{filteredServices.length}</span> government services
                    </>
                  )}
                </p>
              </div>
