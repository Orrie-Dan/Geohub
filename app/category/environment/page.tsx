...
// Environmental application data
const environmentalApps = [
  {
    id: 1,
    title: "Protected Area Mapping and Monitoring Application",
  ...
  {
    id: 2,
    title: "Biodiversity Mapping Application",
  ...
  {
    id: 3,
    title: "Air Quality and Pollution Mapping Application",
...
export default function EnvironmentalApps() {
  ...
  const handleLaunch = useCallback((app: { launchUrl: string; title: string }) => {
    if (app.launchUrl && app.launchUrl !== '#') {
      window.open(app.launchUrl, '_blank', 'noopener,noreferrer')
    } else {
      // Handle apps without URLs - you can show a message or redirect to a coming soon page
      alert(`${app.title} will be available soon!`)
    }
  }, [])
  ...
  return (
    <main className="flex min-h-screen flex-col relative">
      ...
      <div className="fixed inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-emerald-950/60 via-slate-950/40 to-slate-950/70"></div>
      </div>
          ...
          <div className="container relative z-10 px-4 mx-auto">
            <ScrollReveal>
              ...
              <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-emerald-400 tracking-tight drop-shadow-lg mb-4">
                  Environmental Applications
                </h1>
                <p className="text-xl text-slate-200 max-w-3xl mx-auto drop-shadow-sm">
                  Advanced environmental monitoring and conservation tools to protect Rwanda's natural resources, 
                  track ecosystem health, and support sustainable development initiatives
                </p>
              </div>
              ...
              <div className="text-center text-slate-300 mb-8">
                <p>
                  {searchQuery ? (
                    ...
                    <>
                      Showing <span className="text-emerald-400 font-semibold">{filteredApps.length}</span> environmental applications
                    </>
                  )}
                </p>
              </div>
