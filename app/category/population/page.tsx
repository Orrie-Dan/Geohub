...
const populationApps = [
  {
    ...
    description: "A comprehensive tool for mapping and analyzing population distribution, demographics, and census data across Rwanda, providing insights for urban planning and resource allocation",
    keywords: ["population", "demographics", "census", "mapping", "urban planning", "Rwanda", "statistics"],
    link: "https://nisrgis.maps.arcgis.com/apps/dashboards/e2d8d8a4775842deaeba1642eb7b6534"
  }
]
